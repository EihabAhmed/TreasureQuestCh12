...
public class LevelScreen extends BaseScreen {
    ...
    public void update(float dt) {
        ...
        if (!sword.isVisible()) {
            ...
            for (BaseActor solid : BaseActor.getList(mainStage, "com.mygdx.treasurequestch12.Solid")) {
                hero.preventOverlap(solid);
            }
        }

        if (sword.isVisible()) {
            for (BaseActor bush : BaseActor.getList(mainStage, "com.mygdx.treasurequestch12.Bush")) {
                if (sword.overlaps(bush))
                    bush.remove();
            }

            for (BaseActor flyer : BaseActor.getList(mainStage, "com.mygdx.treasurequestch12.Flyer")) {
        ...
        for (BaseActor coin : BaseActor.getList(mainStage, "com.mygdx.treasurequestch12.Coin")) {
        ...
        for (BaseActor arrow : BaseActor.getList(mainStage, "com.mygdx.treasurequestch12.Arrow")) {
            for (BaseActor flyer : BaseActor.getList(mainStage, "com.mygdx.treasurequestch12.Flyer")) {
        ...
        for (BaseActor npcActor : BaseActor.getList(mainStage, "com.mygdx.treasurequestch12.NPC")) {
            ...
            if (nearby && !npc.isViewing()) {
                ...
                if (npc.getID().equals("Gatekeeper")) {
                    int flyerCount = BaseActor.getList(mainStage, "com.mygdx.treasurequestch12.Flyer").size();
